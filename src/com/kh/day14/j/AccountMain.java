package com.kh.day14.j;

import com.kh.day10.Account;
...
public class AccountMain {
  ...
  private static com.kh.day10.Account[] accounts;              // 계좌를 담는 배열


  public static void main(String[] args) {
    accounts = new com.kh.day10.Account[OPEN_ACCOUNT_LIMIT];
...
//            }
  ...
  private static int findNullIndex(Account[] accounts) {
    ...
    throw new RuntimeException("인덱스를 찾을 수 없습니다");
    //return -1;
  }
}
